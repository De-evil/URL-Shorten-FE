          ...
          <div className="row justify-content-center">
            <div className="col-sm-10 col-md-8 col-lg-8 col-xl-8">
              ...
              <div className="d-flex justify-content-center gap-2">
                <button className="btn btn-outline-success"><i className="bi bi-google"><Link  to={'/login'}>Login</Link></i></button>
                <button className="btn btn-outline-success"><i className="bi bi-github"> <Link to={'/register'}>Signup</Link></i></button>
              </div>
            </div>
          </div>
        </div>
